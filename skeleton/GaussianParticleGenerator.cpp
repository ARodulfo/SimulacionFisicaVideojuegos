...
GaussianParticleGenerator::GaussianParticleGenerator(Vector3 _std_dev_pos, Vector3 _std_dev_vel, std::string name, Vector3 mean_pos, Vector3 mean_vel, int num_particles, double partVida, Vector3 aSpace) : ParticleGenerator(name, mean_pos, mean_vel, num_particles, partVida, aSpace)
{
